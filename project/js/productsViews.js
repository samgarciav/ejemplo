export default class ProductsView {
  renderProducts(products, parent) { //parent=.productsGrid
    ...
    products.forEach((product, index) => {
      if (index < 5) {      // This if is to add the lazy loading to the first 5 images
        if (col == 1) {
        ...
        if (col == 1) {
          div1.appendChild(this.renderEachProductLazy(product));
          col++;
        } else {
          div2.appendChild(this.renderEachProductLazy(product));
          col--;
        }
      }
    });
                ...
                <figure>
                  <picture>
                    ...
                    <img width="1000" height="1000" src="images/Cadena_de_Oro_10k_Italiana_Guchi_diamantada.webp"
                      ...
                      title="${product.Category} ${product.Purity}">
                  </picture>
    ...
    if (parseFloat(product.Discount) > 0) {
      ...
      <div class="productImg">
                <figure>
                  <picture>
                    <source media="(max-width:650px)" srcset="images/optimized250.jpg">
                    <img loading="lazy" width="1000" height="1000" src="images/Cadena_de_Oro_10k_Italiana_Guchi_diamantada.webp"
                      alt="Cadena_de_Oro_10k_Italiana_Guchi diamantada.webp"
                      title="${product.Category} ${product.Purity}">
                  </picture>
                  <figcaption class="description sr-only">${product.Description}</figcaption>
